...
export const DEX_2026 = [
  ...
  { id: 'TR1', nom: 'Le Petit Teigneux', type: 'voix', set: 'TR', stage: 1, rar: 'd1',
  ...
  { id: 'TR2', nom: 'Le Collectionneur', type: 'fide', set: 'TR', stage: 1, rar: 'd1',
  ...
  { id: 'TR3', nom: 'Le Porteur de Banderole', type: 'tifo', set: 'TR', stage: 1, rar: 'd2',
  ...
  { id: 'TR4', nom: 'Le Casque sur les Oreilles', type: 'voix', set: 'TR', stage: 1, rar: 'd1',
  ...
  { id: 'TR5', nom: 'La Cagoule Timide', type: 'fide', set: 'TR', stage: 1, rar: 'd2',
  ...
  { id: 'TR6', nom: 'Celui Qui Ne Regarde Pas', type: 'fide', set: 'TR', stage: 1, rar: 'd2',
  ...
  { id: 'TR7', nom: 'Les Doigts Croisés', type: 'fide', set: 'TR', stage: 1, rar: 'd2',
  ...
  { id: 'TR8', nom: 'Le Porteur d’Épaules', type: 'depl', set: 'TR', stage: 1, rar: 'd2',
  ...
  { id: 'TR9', nom: 'L’Écharpe Levée', type: 'tifo', set: 'TR', stage: 1, rar: 'd3',
  ...
  { id: 'TR10', nom: 'Le Paquet de Chips', type: 'depl', set: 'TR', stage: 1, rar: 'd1',
  ...
  { id: 'TR11', nom: 'La Tricoteuse', type: 'fide', set: 'TR', stage: 1, rar: 'd3',
  ...
  { id: 'TR12', nom: 'Le Ballon de Cuir', type: 'fide', set: 'TR', stage: 1, rar: 'star',
  ...
  { id: 'TR13', nom: 'Le Bébé Vainqueur', type: 'voix', set: 'TR', stage: 1, rar: 'd2',
  ...
  { id: 'TR14', nom: 'La Chaise Pliante', type: 'depl', set: 'TR', stage: 1, rar: 'd1',
  ...
  { id: 'TR15', nom: 'Le Torse Peint', type: 'perc', set: 'TR', stage: 1, rar: 'd2',
  ...
  { id: 'TR16', nom: 'La Perche à Selfie', type: 'voix', set: 'TR', stage: 1, rar: 'd1',
  ...
  { id: 'TR17', nom: 'Le Pyjama Hippopotame', type: 'depl', set: 'TR', stage: 1, rar: 'd2',
  ...
  { id: 'TR18', nom: 'Le Mégaphone', type: 'voix', set: 'TR', stage: 1, rar: 'd3',
  ...
  { id: 'TR19', nom: 'Le Tambour de Guerre', type: 'perc', set: 'TR', stage: 1, rar: 'd3',
  ...
  { id: 'TR20', nom: 'Le Héros du Dimanche', type: 'tifo', set: 'TR', stage: 1, rar: 'd1',
  ...
  { id: 'TR21', nom: 'Le Fumigène', type: 'pyro', set: 'TR', stage: 1, rar: 'd3',
  ...
  { id: 'TR22', nom: 'La Manette', type: 'perc', set: 'TR', stage: 1, rar: 'd1',
  ...
  { id: 'TR23', nom: 'La Coupe Levée', type: 'voix', set: 'TR', stage: 1, rar: 'd1',
  ...
  { id: 'TR24', nom: 'La Poussette', type: 'fide', set: 'TR', stage: 1, rar: 'd1',
  ...
  { id: 'TR25', nom: 'La Remplaçante', type: 'perc', set: 'TR', stage: 1, rar: 'd2',
  ...
  { id: 'TR26', nom: 'La Boue aux Genoux', type: 'depl', set: 'TR', stage: 1, rar: 'd2',
  ...
  { id: 'TR27', nom: 'Le Pyjama à Pompon', type: 'voix', set: 'TR', stage: 1, rar: 'd1',
  ...
  { id: 'MS1', nom: 'La Tireuse de Pression', type: 'depl', set: 'MS', stage: 1, rar: 'd2',
  ...
  { id: 'MS2', nom: 'Le Mime du Parvis', type: 'tifo', set: 'MS', stage: 1, rar: 'd2',
  ...
  { id: 'MS3', nom: 'Le Marchand de Gobelets', type: 'depl', set: 'MS', stage: 1, rar: 'd1',
  ...
  { id: 'MS4', nom: 'La Dame du Vent', type: 'fide', set: 'MS', stage: 1, rar: 'd2',
  ...
  { id: 'MS5', nom: 'La Stadière', type: 'tifo', set: 'MS', stage: 1, rar: 'd2',
  ...
  { id: 'MS6', nom: 'Le Laveur de Vitres', type: 'depl', set: 'MS', stage: 1, rar: 'd2',
  ...
  { id: 'MS7', nom: 'Le Bûcheron de Buvette', type: 'perc', set: 'MS', stage: 1, rar: 'd2',
  ...
  { id: 'MS8', nom: 'L’Apicultrice', type: 'fide', set: 'MS', stage: 1, rar: 'd3',
  ...
  { id: 'MS9', nom: 'Le Ramoneur', type: 'pyro', set: 'MS', stage: 1, rar: 'd2',
  ...
  { id: 'MS10', nom: 'La Cheffe de la Buvette', type: 'perc', set: 'MS', stage: 1, rar: 'd3',
  ...
  { id: 'MS11', nom: 'Le Pompier de Garde', type: 'tifo', set: 'MS', stage: 1, rar: 'd2',
  ...
  { id: 'MS12', nom: 'Le Vieux Marin', type: 'fide', set: 'MS', stage: 1, rar: 'd2',
  ...
  { id: 'MS13', nom: 'L’Infirmière du Stade', type: 'fide', set: 'MS', stage: 1, rar: 'd3',
  ...
  { id: 'MS14', nom: 'Le Boulanger d’En Face', type: 'depl', set: 'MS', stage: 1, rar: 'd1',
  ...
  { id: 'MS15', nom: 'La Grosse Caisse', type: 'perc', set: 'MS', stage: 1, rar: 'star',
  ...
  { id: 'MS16', nom: 'L’Homme au Carton', type: 'tifo', set: 'MS', stage: 1, rar: 'd3',
  ...
  { id: 'MS17', nom: 'Le Facteur', type: 'depl', set: 'MS', stage: 1, rar: 'd1',
  ...
  { id: 'MS18', nom: 'La Marchande de Bretzels', type: 'depl', set: 'MS', stage: 1, rar: 'd2',
  ...
  { id: 'MS19', nom: 'Le Juge de Touche', type: 'tifo', set: 'MS', stage: 1, rar: 'd2',
  ...
  { id: 'MS20', nom: 'Le Vendeur à la Sauvette', type: 'depl', set: 'MS', stage: 1, rar: 'd3',
  ...
  { id: 'MS21', nom: 'Le Costume Cravate', type: 'tifo', set: 'MS', stage: 1, rar: 'd3',
  ...
  { id: 'MS22', nom: 'La Trompette du Dimanche', type: 'voix', set: 'MS', stage: 1, rar: 'd2',
  ...
  { id: 'MS23', nom: 'La Voyante du Parvis', type: 'pyro', set: 'MS', stage: 1, rar: 'd3',
  ...
  { id: 'MS24', nom: 'Le Sifflet', type: 'tifo', set: 'MS', stage: 1, rar: 'star',
  ...
  { id: 'MS25', nom: 'Le Roi de la Grillade', type: 'pyro', set: 'MS', stage: 1, rar: 'd2',
  ...
  { id: 'MS26', nom: 'Le Recruteur', type: 'fide', set: 'MS', stage: 1, rar: 'd2',
  ...
  { id: 'BG1', nom: 'Le Hibou Statisticien', type: 'fide', set: 'BG', stage: 1, rar: 'd2',
  ...
  { id: 'BG2', nom: 'Le Pigeon à la Frite', type: 'depl', set: 'BG', stage: 1, rar: 'd1',
  ...
  { id: 'BG3', nom: 'Le Morse de la Tribune Nord', type: 'fide', set: 'BG', stage: 1, rar: 'd3',
  ...
  { id: 'BG4', nom: 'Le Coq de la Pelouse', type: 'voix', set: 'BG', stage: 1, rar: 'd2',
  ...
  { id: 'BG5', nom: 'Le Crabe de Touche', type: 'perc', set: 'BG', stage: 1, rar: 'd1',
  ...
  { id: 'BG6', nom: 'L’Élan des Travées', type: 'depl', set: 'BG', stage: 1, rar: 'd2',
  ...
  { id: 'BG7', nom: 'Le Hérisson Emmitouflé', type: 'fide', set: 'BG', stage: 1, rar: 'd1',
  ...
  { id: 'BG8', nom: 'Le Lama Blasé', type: 'tifo', set: 'BG', stage: 1, rar: 'd2',
  ...
  { id: 'BG9', nom: 'Le Raton du Vestiaire', type: 'depl', set: 'BG', stage: 1, rar: 'd2',
  ...
  { id: 'BG10', nom: 'Le Teckel Interminable', type: 'perc', set: 'BG', stage: 1, rar: 'd1',
  ...
  { id: 'BG11', nom: 'Le Manchot en Nœud Papillon', type: 'fide', set: 'BG', stage: 1, rar: 'd2',
  ...
  { id: 'BG12', nom: 'La Tortue de la Rampe', type: 'fide', set: 'BG', stage: 1, rar: 'd3',
  ...
  { id: 'BG13', nom: 'La Fourmi Porteuse', type: 'perc', set: 'BG', stage: 1, rar: 'd2',
  ...
  { id: 'BG14', nom: 'La Méduse Fluo', type: 'tifo', set: 'BG', stage: 1, rar: 'd3',
  ...
  { id: 'BG15', nom: 'Le Chat du Terrain', type: 'depl', set: 'BG', stage: 1, rar: 'd3',
  ...
  { id: 'BG16', nom: 'Le Pigeon à Casquette', type: 'voix', set: 'BG', stage: 1, rar: 'd1',
  ...
  { id: 'BG17', nom: 'Le Paresseux de la Barre', type: 'fide', set: 'BG', stage: 1, rar: 'd2',
  ...
  { id: 'BG18', nom: 'La Pieuvre du Virage', type: 'perc', set: 'BG', stage: 1, rar: 'star',
  ...
  { id: 'BG19', nom: 'Le Capybara Serein', type: 'fide', set: 'BG', stage: 1, rar: 'd3',
  ...
  { id: 'BG20', nom: 'L’Abeille de Chantier', type: 'depl', set: 'BG', stage: 1, rar: 'd1',
  ...
  { id: 'BG21', nom: 'L’Orang-outan en Costume', type: 'tifo', set: 'BG', stage: 1, rar: 'd3',
  ...
  { id: 'BG22', nom: 'Le Caméléon en Smoking', type: 'tifo', set: 'BG', stage: 1, rar: 'd2',
  ...
  { id: 'BG23', nom: 'Le Loup du Parcage', type: 'perc', set: 'BG', stage: 1, rar: 'd2',
  ...
  { id: 'RV1', nom: 'La Chose du Bocal', type: 'pyro', set: 'RV', stage: 1, rar: 'd3',
  ...
  { id: 'RV2', nom: 'Le Phénix du Virage', type: 'pyro', set: 'RV', stage: 1, rar: 'star',
  ...
  { id: 'RV3', nom: 'Le Lutin des Vestiaires', type: 'depl', set: 'RV', stage: 1, rar: 'd2',
  ...
  { id: 'RV4', nom: 'La Vapeur de la Théière', type: 'fide', set: 'RV', stage: 1, rar: 'd3',
  ...
  { id: 'RV5', nom: 'Le Loup-Garou du Samedi', type: 'perc', set: 'RV', stage: 1, rar: 'd3',
  ...
  { id: 'RV6', nom: 'Le Recousu', type: 'fide', set: 'RV', stage: 1, rar: 'd3',
  ...
  { id: 'RV7', nom: 'L’Abonné d’Outre-Tombe', type: 'fide', set: 'RV', stage: 1, rar: 'd2',
  ...
  { id: 'RV8', nom: 'Le Troll du Pont', type: 'perc', set: 'RV', stage: 1, rar: 'd2',
  ...
  { id: 'RV9', nom: 'La Sirène du Seau', type: 'voix', set: 'RV', stage: 1, rar: 'd3',
  ...
  { id: 'RV10', nom: 'Le Minotaure des Coursives', type: 'tifo', set: 'RV', stage: 1, rar: 'star',
  ...
  { id: 'RV11', nom: 'La Sorcière du Parking', type: 'pyro', set: 'RV', stage: 1, rar: 'd3',
  ...
  { id: 'RV12', nom: 'Le Golem du Muret', type: 'fide', set: 'RV', stage: 1, rar: 'star',
  ...
  { id: 'RV13', nom: 'Le Cyclope du Grand Écran', type: 'voix', set: 'RV', stage: 1, rar: 'd2',
  ...
  { id: 'RV14', nom: 'Le Petit Fantôme', type: 'depl', set: 'RV', stage: 1, rar: 'd1',
  ...
  { id: 'RV15', nom: 'Le Bébé Dragon', type: 'pyro', set: 'RV', stage: 1, rar: 'd3',
  ...
  { id: 'RV16', nom: 'La Momie du Musée', type: 'fide', set: 'RV', stage: 1, rar: 'd2',
  ...
  { id: 'RV17', nom: 'Le Yéti à la Trompette', type: 'voix', set: 'RV', stage: 1, rar: 'd3',
  ...
  { id: 'RV18', nom: 'La Faucheuse au Pop-corn', type: 'tifo', set: 'RV', stage: 1, rar: 'crown',
  ...
  { id: 'RV19', nom: 'Le Vampire du Nocturne', type: 'depl', set: 'RV', stage: 1, rar: 'd3',
  ...
  { id: 'RV20', nom: 'Le Fantôme du Bloc C', type: 'fide', set: 'RV', stage: 1, rar: 'crown',
  ...
  { id: 'RV21', nom: 'La Plante du Parvis', type: 'perc', set: 'RV', stage: 1, rar: 'd2',
  ...
  { id: 'OB1', nom: 'La Main en Mousse', type: 'tifo', set: 'OB', stage: 1, rar: 'd1',
  ...
  { id: 'OB2', nom: 'Le Siège 14B', type: 'fide', set: 'OB', stage: 1, rar: 'd2',
  ...
  { id: 'OB3', nom: 'Le Pantin Remontable', type: 'perc', set: 'OB', stage: 1, rar: 'd2',
  ...
  { id: 'OB4', nom: 'Le Danseur Gonflable', type: 'voix', set: 'OB', stage: 1, rar: 'd1',
  ...
  { id: 'OB5', nom: 'Le Cône du Parking', type: 'depl', set: 'OB', stage: 1, rar: 'd1',
  ...
  { id: 'OB6', nom: 'Le Distributeur', type: 'depl', set: 'OB', stage: 1, rar: 'd3',
  ...
  { id: 'OB7', nom: 'L’Épouvantail du Terrain d’Entraînement', type: 'tifo', set: 'OB', stage: 1, rar: 'd2',
  ...
  { id: 'OB8', nom: 'Le Bonhomme de Neige', type: 'fide', set: 'OB', stage: 1, rar: 'd2',
  ...
  { id: 'OB9', nom: 'La Machine à Thé', type: 'fide', set: 'OB', stage: 1, rar: 'd2',
  ...
  { id: 'OB10', nom: 'Le Téléviseur du Café', type: 'perc', set: 'OB', stage: 1, rar: 'd3',
  ...
  { id: 'OB11', nom: 'Le Nain de Jardin', type: 'tifo', set: 'OB', stage: 1, rar: 'd1',
  ...
  { id: 'OB12', nom: 'Le Poulet en Caoutchouc', type: 'voix', set: 'OB', stage: 1, rar: 'd2',
  ...
  { id: 'EP1', nom: 'L’Homme des Cavernes', type: 'perc', set: 'EP', stage: 1, rar: 'd2',
  ...
  { id: 'EP2', nom: 'Le Bouffon', type: 'pyro', set: 'EP', stage: 1, rar: 'd3',
  ...
  { id: 'EP3', nom: 'L’Aviateur', type: 'depl', set: 'EP', stage: 1, rar: 'd2',
  ...
  { id: 'EP4', nom: 'Le Mousquetaire', type: 'tifo', set: 'EP', stage: 1, rar: 'd3',
  ...
  { id: 'EP5', nom: 'Le Samouraï', type: 'fide', set: 'EP', stage: 1, rar: 'star',
  ...
  { id: 'EP6', nom: 'Le Légionnaire', type: 'tifo', set: 'EP', stage: 1, rar: 'd2',
  ...
  { id: 'EP7', nom: 'La Viking', type: 'voix', set: 'EP', stage: 1, rar: 'd3',
  ...
  { id: 'EP8', nom: 'Le Crieur Public', type: 'voix', set: 'EP', stage: 1, rar: 'd2',
  ...
  { id: 'EP9', nom: 'Le Savant Fou', type: 'pyro', set: 'EP', stage: 1, rar: 'd3',
  ...
  { id: 'EP10', nom: 'Le Cowboy', type: 'fide', set: 'EP', stage: 1, rar: 'd2',
  ...
  { id: 'EP11', nom: 'La Pirate', type: 'depl', set: 'EP', stage: 1, rar: 'd3',
  ...
  { id: 'EP12', nom: 'L’Astronaute', type: 'depl', set: 'EP', stage: 1, rar: 'd3',
  ...
  { id: 'EP13', nom: 'Le Scaphandrier', type: 'fide', set: 'EP', stage: 1, rar: 'd2',
  ...
  { id: 'EP14', nom: 'Le Chevalier', type: 'tifo', set: 'EP', stage: 1, rar: 'd3',
  ...
  { id: 'EP15', nom: 'Le Touriste d’Ailleurs', type: 'depl', set: 'EP', stage: 1, rar: 'star',
  ...
  { id: 'EP16', nom: 'Le Flottant', type: 'voix', set: 'EP', stage: 1, rar: 'd2',
  ...
  { id: 'EP17', nom: 'Le Gladiateur', type: 'perc', set: 'EP', stage: 1, rar: 'crown',
