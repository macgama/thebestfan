...
export const DEX_2026 = [
  ...
  { id: 'TR3', nom: 'Le Porteur de Banderole', type: 'tifo', set: 'TR', stage: 1, rar: 'rare',
  ...
  { id: 'TR5', nom: 'La Cagoule Timide', type: 'fide', set: 'TR', stage: 1, rar: 'rare',
  ...
  { id: 'TR6', nom: 'Celui Qui Ne Regarde Pas', type: 'fide', set: 'TR', stage: 1, rar: 'rare',
  ...
  { id: 'TR7', nom: 'Les Doigts Croisés', type: 'fide', set: 'TR', stage: 1, rar: 'rare',
  ...
  { id: 'TR8', nom: 'Le Porteur d’Épaules', type: 'depl', set: 'TR', stage: 1, rar: 'rare',
  ...
  { id: 'TR9', nom: 'L’Écharpe Levée', type: 'tifo', set: 'TR', stage: 1, rar: 'epique',
  ...
  { id: 'TR11', nom: 'La Tricoteuse', type: 'fide', set: 'TR', stage: 1, rar: 'epique',
  ...
  { id: 'TR13', nom: 'Le Bébé Vainqueur', type: 'voix', set: 'TR', stage: 1, rar: 'rare',
  ...
  { id: 'TR15', nom: 'Le Torse Peint', type: 'perc', set: 'TR', stage: 1, rar: 'rare',
  ...
  { id: 'TR17', nom: 'Le Pyjama Hippopotame', type: 'depl', set: 'TR', stage: 1, rar: 'rare',
  ...
  { id: 'TR18', nom: 'Le Mégaphone', type: 'voix', set: 'TR', stage: 1, rar: 'epique',
  ...
  { id: 'TR19', nom: 'Le Tambour de Guerre', type: 'perc', set: 'TR', stage: 1, rar: 'epique',
  ...
  { id: 'TR21', nom: 'Le Fumigène', type: 'pyro', set: 'TR', stage: 1, rar: 'epique',
  ...
  { id: 'TR25', nom: 'La Remplaçante', type: 'perc', set: 'TR', stage: 1, rar: 'rare',
  ...
  { id: 'TR26', nom: 'La Boue aux Genoux', type: 'depl', set: 'TR', stage: 1, rar: 'rare',
  ...
  { id: 'MS1', nom: 'La Tireuse de Pression', type: 'depl', set: 'MS', stage: 1, rar: 'rare',
  ...
  { id: 'MS2', nom: 'Le Mime du Parvis', type: 'tifo', set: 'MS', stage: 1, rar: 'rare',
  ...
  { id: 'MS4', nom: 'La Dame du Vent', type: 'fide', set: 'MS', stage: 1, rar: 'rare',
  ...
  { id: 'MS5', nom: 'La Stadière', type: 'tifo', set: 'MS', stage: 1, rar: 'rare',
  ...
  { id: 'MS6', nom: 'Le Laveur de Vitres', type: 'depl', set: 'MS', stage: 1, rar: 'rare',
  ...
  { id: 'MS7', nom: 'Le Bûcheron de Buvette', type: 'perc', set: 'MS', stage: 1, rar: 'rare',
  ...
  { id: 'MS8', nom: 'L’Apicultrice', type: 'fide', set: 'MS', stage: 1, rar: 'epique',
  ...
  { id: 'MS9', nom: 'Le Ramoneur', type: 'pyro', set: 'MS', stage: 1, rar: 'rare',
  ...
  { id: 'MS10', nom: 'La Cheffe de la Buvette', type: 'perc', set: 'MS', stage: 1, rar: 'epique',
  ...
  { id: 'MS11', nom: 'Le Pompier de Garde', type: 'tifo', set: 'MS', stage: 1, rar: 'rare',
  ...
  { id: 'MS12', nom: 'Le Vieux Marin', type: 'fide', set: 'MS', stage: 1, rar: 'rare',
  ...
  { id: 'MS13', nom: 'L’Infirmière du Stade', type: 'fide', set: 'MS', stage: 1, rar: 'epique',
  ...
  { id: 'MS16', nom: 'L’Homme au Carton', type: 'tifo', set: 'MS', stage: 1, rar: 'epique',
  ...
  { id: 'MS18', nom: 'La Marchande de Bretzels', type: 'depl', set: 'MS', stage: 1, rar: 'rare',
  ...
  { id: 'MS19', nom: 'Le Juge de Touche', type: 'tifo', set: 'MS', stage: 1, rar: 'rare',
  ...
  { id: 'MS20', nom: 'Le Vendeur à la Sauvette', type: 'depl', set: 'MS', stage: 1, rar: 'epique',
  ...
  { id: 'MS21', nom: 'Le Costume Cravate', type: 'tifo', set: 'MS', stage: 1, rar: 'epique',
  ...
  { id: 'MS22', nom: 'La Trompette du Dimanche', type: 'voix', set: 'MS', stage: 1, rar: 'rare',
  ...
  { id: 'MS23', nom: 'La Voyante du Parvis', type: 'pyro', set: 'MS', stage: 1, rar: 'epique',
  ...
  { id: 'MS25', nom: 'Le Roi de la Grillade', type: 'pyro', set: 'MS', stage: 1, rar: 'rare',
  ...
  { id: 'MS26', nom: 'Le Recruteur', type: 'fide', set: 'MS', stage: 1, rar: 'rare',
  ...
  { id: 'BG1', nom: 'Le Hibou Statisticien', type: 'fide', set: 'BG', stage: 1, rar: 'rare',
  ...
  { id: 'BG3', nom: 'Le Morse de la Tribune Nord', type: 'fide', set: 'BG', stage: 1, rar: 'epique',
  ...
  { id: 'BG4', nom: 'Le Coq de la Pelouse', type: 'voix', set: 'BG', stage: 1, rar: 'rare',
  ...
  { id: 'BG6', nom: 'L’Élan des Travées', type: 'depl', set: 'BG', stage: 1, rar: 'rare',
  ...
  { id: 'BG8', nom: 'Le Lama Blasé', type: 'tifo', set: 'BG', stage: 1, rar: 'rare',
  ...
  { id: 'BG9', nom: 'Le Raton du Vestiaire', type: 'depl', set: 'BG', stage: 1, rar: 'rare',
  ...
  { id: 'BG11', nom: 'Le Manchot en Nœud Papillon', type: 'fide', set: 'BG', stage: 1, rar: 'rare',
  ...
  { id: 'BG12', nom: 'La Tortue de la Rampe', type: 'fide', set: 'BG', stage: 1, rar: 'epique',
  ...
  { id: 'BG13', nom: 'La Fourmi Porteuse', type: 'perc', set: 'BG', stage: 1, rar: 'rare',
  ...
  { id: 'BG14', nom: 'La Méduse Fluo', type: 'tifo', set: 'BG', stage: 1, rar: 'epique',
  ...
  { id: 'BG15', nom: 'Le Chat du Terrain', type: 'depl', set: 'BG', stage: 1, rar: 'epique',
  ...
  { id: 'BG17', nom: 'Le Paresseux de la Barre', type: 'fide', set: 'BG', stage: 1, rar: 'rare',
  ...
  { id: 'BG19', nom: 'Le Capybara Serein', type: 'fide', set: 'BG', stage: 1, rar: 'epique',
  ...
  { id: 'BG21', nom: 'L’Orang-outan en Costume', type: 'tifo', set: 'BG', stage: 1, rar: 'epique',
  ...
  { id: 'BG22', nom: 'Le Caméléon en Smoking', type: 'tifo', set: 'BG', stage: 1, rar: 'rare',
  ...
  { id: 'BG23', nom: 'Le Loup du Parcage', type: 'perc', set: 'BG', stage: 1, rar: 'rare',
  ...
  { id: 'RV1', nom: 'La Chose du Bocal', type: 'pyro', set: 'RV', stage: 1, rar: 'epique',
  ...
  { id: 'RV3', nom: 'Le Lutin des Vestiaires', type: 'depl', set: 'RV', stage: 1, rar: 'rare',
  ...
  { id: 'RV4', nom: 'La Vapeur de la Théière', type: 'fide', set: 'RV', stage: 1, rar: 'epique',
  ...
  { id: 'RV5', nom: 'Le Loup-Garou du Samedi', type: 'perc', set: 'RV', stage: 1, rar: 'epique',
  ...
  { id: 'RV6', nom: 'Le Recousu', type: 'fide', set: 'RV', stage: 1, rar: 'epique',
  ...
  { id: 'RV7', nom: 'L’Abonné d’Outre-Tombe', type: 'fide', set: 'RV', stage: 1, rar: 'rare',
  ...
  { id: 'RV8', nom: 'Le Troll du Pont', type: 'perc', set: 'RV', stage: 1, rar: 'rare',
  ...
  { id: 'RV9', nom: 'La Sirène du Seau', type: 'voix', set: 'RV', stage: 1, rar: 'epique',
  ...
  { id: 'RV11', nom: 'La Sorcière du Parking', type: 'pyro', set: 'RV', stage: 1, rar: 'epique',
  ...
  { id: 'RV13', nom: 'Le Cyclope du Grand Écran', type: 'voix', set: 'RV', stage: 1, rar: 'rare',
  ...
  { id: 'RV15', nom: 'Le Bébé Dragon', type: 'pyro', set: 'RV', stage: 1, rar: 'epique',
  ...
  { id: 'RV16', nom: 'La Momie du Musée', type: 'fide', set: 'RV', stage: 1, rar: 'rare',
  ...
  { id: 'RV17', nom: 'Le Yéti à la Trompette', type: 'voix', set: 'RV', stage: 1, rar: 'epique',
  ...
  { id: 'RV19', nom: 'Le Vampire du Nocturne', type: 'depl', set: 'RV', stage: 1, rar: 'epique',
  ...
  { id: 'RV21', nom: 'La Plante du Parvis', type: 'perc', set: 'RV', stage: 1, rar: 'rare',
  ...
  { id: 'OB2', nom: 'Le Siège 14B', type: 'fide', set: 'OB', stage: 1, rar: 'rare',
  ...
  { id: 'OB3', nom: 'Le Pantin Remontable', type: 'perc', set: 'OB', stage: 1, rar: 'rare',
  ...
  { id: 'OB6', nom: 'Le Distributeur', type: 'depl', set: 'OB', stage: 1, rar: 'epique',
  ...
  { id: 'OB7', nom: 'L’Épouvantail du Terrain d’Entraînement', type: 'tifo', set: 'OB', stage: 1, rar: 'rare',
  ...
  { id: 'OB8', nom: 'Le Bonhomme de Neige', type: 'fide', set: 'OB', stage: 1, rar: 'rare',
  ...
  { id: 'OB9', nom: 'La Machine à Thé', type: 'fide', set: 'OB', stage: 1, rar: 'rare',
  ...
  { id: 'OB10', nom: 'Le Téléviseur du Café', type: 'perc', set: 'OB', stage: 1, rar: 'epique',
  ...
  { id: 'OB12', nom: 'Le Poulet en Caoutchouc', type: 'voix', set: 'OB', stage: 1, rar: 'rare',
  ...
  { id: 'EP1', nom: 'L’Homme des Cavernes', type: 'perc', set: 'EP', stage: 1, rar: 'rare',
  ...
  { id: 'EP2', nom: 'Le Bouffon', type: 'pyro', set: 'EP', stage: 1, rar: 'epique',
  ...
  { id: 'EP3', nom: 'L’Aviateur', type: 'depl', set: 'EP', stage: 1, rar: 'rare',
  ...
  { id: 'EP4', nom: 'Le Mousquetaire', type: 'tifo', set: 'EP', stage: 1, rar: 'epique',
  ...
  { id: 'EP6', nom: 'Le Légionnaire', type: 'tifo', set: 'EP', stage: 1, rar: 'rare',
  ...
  { id: 'EP7', nom: 'La Viking', type: 'voix', set: 'EP', stage: 1, rar: 'epique',
  ...
  { id: 'EP8', nom: 'Le Crieur Public', type: 'voix', set: 'EP', stage: 1, rar: 'rare',
  ...
  { id: 'EP9', nom: 'Le Savant Fou', type: 'pyro', set: 'EP', stage: 1, rar: 'epique',
  ...
  { id: 'EP10', nom: 'Le Cowboy', type: 'fide', set: 'EP', stage: 1, rar: 'rare',
  ...
  { id: 'EP11', nom: 'La Pirate', type: 'depl', set: 'EP', stage: 1, rar: 'epique',
  ...
  { id: 'EP12', nom: 'L’Astronaute', type: 'depl', set: 'EP', stage: 1, rar: 'epique',
  ...
  { id: 'EP13', nom: 'Le Scaphandrier', type: 'fide', set: 'EP', stage: 1, rar: 'rare',
  ...
  { id: 'EP14', nom: 'Le Chevalier', type: 'tifo', set: 'EP', stage: 1, rar: 'epique',
  ...
  { id: 'EP16', nom: 'Le Flottant', type: 'voix', set: 'EP', stage: 1, rar: 'rare',
