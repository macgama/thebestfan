...
const DEX = [
  ...
  { id:'T2', nom:'Bâcheur Nocturne', type:'tifo', set:'MS', stage:2, rar:'rare', evo:'T3',
    ...
    mods:{ parryBonus:1.5 }, cri:{ label:'BÂCHE SURPRISE', gest:'tri', power:62 } },
  { id:'T3', nom:'Chef Tifo', type:'tifo', set:'MS', stage:3, rar:'epique',
    ...
    mods:{ parryBonus:1.9, holdBonus:1.06 }, cri:{ label:'MOSAÏQUE GÉANTE', gest:'tri', power:74 } },
  // --- PYRO
  ...
  { id:'D2', nom:'Conducteur de car', type:'depl', set:'MS', stage:2, rar:'rare', evo:'D3',
    ...
    mods:{ breathBonus:1.16, refundBonus:1.4 }, cri:{ label:'KLAXONS', gest:'memoire', power:64 } },
  { id:'D3', nom:'Convoi 4h du Mat', type:'depl', set:'MS', stage:3, rar:'epique',
    ...
    mods:{ breathBonus:1.24, refundBonus:1.8 }, cri:{ label:'ON EST VENUS POUR ÇA', gest:'memoire', power:76 } },
  // --- sans évolution
  { id:'X1', nom:'Le Douzième Homme', type:'voix', set:'TR', stage:1, rar:'commune',
    mods:{ tempoWindow:1.3, breathBonus:1.1 }, cri:{ label:'OLA', gest:'tempo', power:68 } },
  { id:'X2', nom:'Écharpes au Vent', type:'fide', set:'MT', stage:1, rar:'commune',
    mods:{ holdBonus:1.1 }, cri:{ label:'LEVER LES BRAS', gest:'hold', power:56 } },
  { id:'X3', nom:'Mosaïque Populaire', type:'tifo', set:'TR', stage:1, rar:'commune',
    mods:{ parryBonus:1.3 }, cri:{ label:'DÉPLOIEMENT', gest:'tifo', power:56 } },
  { id:'X4', nom:'Parcage 400 places', type:'depl', set:'GD', stage:1, rar:'legendaire',
   ...
   */
  { id:'X8', nom:'La Mascotte du Dimanche', type:'tifo', set:'TR', stage:1, rar:'commune',
  ...
  { id:'X9', nom:'Le Marchand de Saucisses', publie:false /* refait MS25 */, type:'fide', set:'GC', stage:1, rar:'commune',
  ...
  { id:'X10', nom:'La Patronne du Bar', publie:false /* refait MS1 */, type:'fide', set:'GC', stage:1, rar:'commune',
  ...
  { id:'X11', nom:'La Trompette du Dimanche', publie:false /* refait MS22 */, type:'perc', set:'TR', stage:1, rar:'commune',
  ...
  { id:'X12', nom:'La Voyante du Virage', publie:false /* refait MS23 */, type:'voix', set:'TR', stage:1, rar:'commune',
  ...
  { id:'X13', nom:'L’Agent en Tribune d’Honneur', type:'depl', set:'VP', stage:1, rar:'commune',
  ...
  { id:'X14', nom:'Le Siffleur des Souterrains', type:'tifo', set:'MS', stage:1, rar:'commune',
  ...
  { id:'X15', nom:'Le Loup du Virage', publie:false /* refait BG23 */, type:'pyro', set:'BG', stage:1, rar:'legendaire',
  ...
  { id:'X17', nom:'Le Gosse à la Coupe', publie:false /* refait TR23 */, type:'voix', set:'TR', stage:1, rar:'commune',
  ...
  { id:'X20', nom:'Premier Match', type:'fide', set:'TR', stage:1, rar:'commune',
  ...
  { id:'X26', nom:'Le Tambour de Guerre', publie:false /* refait TR19 */, type:'perc', set:'TR', stage:1, rar:'commune',
  ...
  { id:'X27', nom:'Le Mime du Virage', publie:false /* refait MS2 */, type:'tifo', set:'TR', stage:1, rar:'commune',
  ...
  { id:'X34', nom:'Le Ramasseur de Gobelets', publie:false /* refait MS3 */, type:'fide', set:'GC', stage:1, rar:'commune',
  ...
  { id:'X35', nom:'Le Mégaphone', publie:false /* refait TR18 */, type:'voix', set:'TR', stage:1, rar:'commune',
  ...
  { id:'X42', nom:'La Stadière', publie:false /* refait MS5 */, type:'tifo', set:'MS', stage:1, rar:'commune',
  ...
  { id:'X47', nom:'Le Bob du Dimanche', type:'fide', set:'TR', stage:1, rar:'commune',
  ...
  { id:'X22', nom:'Le Craqueur de la Nuit', publie:false /* refait Y3 */, type:'pyro', set:'TR', stage:1, rar:'commune',
  ...
  { id:'X31', nom:'Le Supporter en Orbite', publie:false /* refait EP12 */, type:'depl', set:'GD', stage:1, rar:'legendaire',
  ...
  { id:'X36', nom:'Le Vendeur d’Écharpes', publie:false /* refait MS20 */, type:'depl', set:'GD', stage:1, rar:'commune',
  ...
  { id:'X37', nom:'Le Juge de Touche', publie:false /* refait MS19 */, type:'tifo', set:'MS', stage:1, rar:'commune',
  ...
  { id:'X40', nom:'La Radio Locale', type:'voix', set:'HC', stage:1, rar:'commune',
  ...
  { id:'X43', nom:'La Streameuse', publie:false /* refait TR16 */, type:'depl', set:'HC', stage:1, rar:'commune',
  ...
  { id:'X46', nom:'Le Peint des Pieds à la Tête', publie:false /* refait TR15 */, type:'pyro', set:'TR', stage:1, rar:'commune',
