...
const DEX = [
  ...
  // --- PERCUSSION
  { id:'P1', nom:'Gamin au tambour', type:'perc', set:'TR', stage:1, rar:'commune', evo:'P2',
  ...
  { id:'P2', nom:'Tambour Major', type:'perc', set:'TR', stage:2, rar:'rare', evo:'P3',
  ...
  { id:'P3', nom:'Grosse Caisse Sud', type:'perc', set:'TR', stage:3, rar:'epique',
  ...
  // --- TIFO
  { id:'T1', nom:'Colleur d\u2019affiches', type:'tifo', set:'TR', stage:1, rar:'commune', evo:'T2',
  ...
  { id:'T2', nom:'Bâcheur Nocturne', type:'tifo', set:'TR', stage:2, rar:'rare', evo:'T3',
  ...
  { id:'T3', nom:'Chef Tifo', type:'tifo', set:'TR', stage:3, rar:'epique',
  ...
  // --- DÉPLACEMENT
  { id:'D1', nom:'Auto-stoppeur', type:'depl', set:'TR', stage:1, rar:'commune', evo:'D2',
  ...
  { id:'D2', nom:'Conducteur de car', type:'depl', set:'TR', stage:2, rar:'rare', evo:'D3',
  ...
  { id:'D3', nom:'Convoi 4h du Mat', type:'depl', set:'TR', stage:3, rar:'epique',
  ...
  // --- sans évolution
  { id:'X1', nom:'Le Douzième Homme', type:'voix', set:'VN', stage:1, rar:'epique',
    mods:{ tempoWindow:1.3, breathBonus:1.1 }, cri:{ label:'OLA', gest:'tempo', power:68 } },
  { id:'X2', nom:'Écharpes au Vent', type:'fide', set:'VN', stage:1, rar:'rare',
    mods:{ holdBonus:1.1 }, cri:{ label:'LEVER LES BRAS', gest:'hold', power:56 } },
  { id:'X3', nom:'Mosaïque Populaire', type:'tifo', set:'NE', stage:1, rar:'rare',
   ...
   */
  { id:'X7', nom:'Le Trieur de Doubles', type:'fide', set:'VN', stage:1, rar:'rare',
   ...
   */
  { id:'X8', nom:'La Mascotte du Dimanche', type:'tifo', set:'VN', stage:1, rar:'rare',
  ...
  { id:'X9', nom:'Le Marchand de Saucisses', type:'fide', set:'VN', stage:1, rar:'commune',
  ...
  { id:'X10', nom:'La Patronne du Bar', type:'fide', set:'VN', stage:1, rar:'rare',
  ...
  { id:'X11', nom:'La Trompette du Dimanche', type:'perc', set:'VN', stage:1, rar:'commune',
  ...
  { id:'X12', nom:'La Voyante du Virage', type:'voix', set:'NE', stage:1, rar:'epique',
  ...
  { id:'X13', nom:'L’Agent en Tribune d’Honneur', type:'depl', set:'NE', stage:1, rar:'rare',
  ...
  { id:'X14', nom:'Le Siffleur des Souterrains', type:'tifo', set:'NE', stage:1, rar:'epique',
  ...
  { id:'X15', nom:'Le Loup du Virage', type:'pyro', set:'NE', stage:1, rar:'legendaire',
  ...
  { id:'X17', nom:'Le Gosse à la Coupe', type:'voix', set:'VN', stage:1, rar:'commune',
  ...
  { id:'X26', nom:'Le Tambour de Guerre', type:'perc', set:'VN', stage:1, rar:'epique',
  ...
  { id:'X27', nom:'Le Mime du Virage', type:'tifo', set:'VN', stage:1, rar:'rare',
  ...
  { id:'X34', nom:'Le Ramasseur de Gobelets', type:'fide', set:'VN', stage:1, rar:'commune',
  ...
  { id:'X35', nom:'Le Mégaphone', type:'voix', set:'VN', stage:1, rar:'epique',
  ...
  { id:'X39', nom:'La Cagoule Rose', type:'tifo', set:'VN', stage:1, rar:'rare',
  ...
  { id:'X41', nom:'L’Homme dans la Mascotte', type:'fide', set:'VN', stage:1, rar:'rare',
  ...
  { id:'X42', nom:'La Stadière', type:'tifo', set:'VN', stage:1, rar:'rare',
  ...
  { id:'X49', nom:'Le Râleur du Rang B', type:'fide', set:'VN', stage:1, rar:'rare',
  ...
  { id:'X22', nom:'Le Craqueur de la Nuit', type:'pyro', set:'NE', stage:1, rar:'epique',
  ...
  { id:'X31', nom:'Le Supporter en Orbite', type:'depl', set:'NE', stage:1, rar:'legendaire',
  ...
  { id:'X36', nom:'Le Vendeur d’Écharpes', type:'depl', set:'NE', stage:1, rar:'rare',
  ...
  { id:'X37', nom:'Le Juge de Touche', type:'tifo', set:'NE', stage:1, rar:'rare',
  ...
  { id:'X40', nom:'La Radio Locale', type:'voix', set:'NE', stage:1, rar:'rare',
  ...
  { id:'X43', nom:'La Streameuse', type:'depl', set:'NE', stage:1, rar:'rare',
  ...
  { id:'X46', nom:'Le Peint des Pieds à la Tête', type:'pyro', set:'NE', stage:1, rar:'rare',
  ...
  { id:'X16', nom:'La Plante du Grillage', type:'voix', set:'IM', stage:1, rar:'rare',
  ...
  { id:'X18', nom:'Le Fantôme de la Tribune Sud', type:'fide', set:'IM', stage:1, rar:'legendaire',
  ...
  { id:'X19', nom:'Le Comte du Parcage', type:'pyro', set:'IM', stage:1, rar:'epique',
  ...
  { id:'X21', nom:'Le Gladiateur en Mousse', type:'perc', set:'IM', stage:1, rar:'rare',
  ...
  { id:'X23', nom:'Le Caméléon en Smoking', type:'tifo', set:'IM', stage:1, rar:'epique',
  ...
  { id:'X24', nom:'La Chouette Statisticienne', type:'voix', set:'IM', stage:1, rar:'rare',
  ...
  { id:'X25', nom:'Le Héros Fatigué', type:'fide', set:'IM', stage:1, rar:'epique',
  ...
  { id:'X28', nom:'La Faucheuse au Pop-corn', type:'fide', set:'IM', stage:1, rar:'legendaire',
  ...
  { id:'X29', nom:'Le Poulet en Caoutchouc', type:'voix', set:'IM', stage:1, rar:'commune',
  ...
  { id:'X30', nom:'Le Videur', type:'tifo', set:'IM', stage:1, rar:'rare',
  ...
  { id:'X33', nom:'Le Nain de Jardin', type:'fide', set:'IM', stage:1, rar:'commune',
  ...
  { id:'X38', nom:'Le Capybara Serein', type:'fide', set:'IM', stage:1, rar:'rare',
  ...
  { id:'X44', nom:'Le Pigeon à la Frite', type:'depl', set:'IM', stage:1, rar:'commune',
  ...
  { id:'X45', nom:'Le Téléviseur', type:'perc', set:'IM', stage:1, rar:'epique',
  ...
  { id:'X50', nom:'La Pieuvre à Lunettes', type:'perc', set:'IM', stage:1, rar:'legendaire',
  ...
  { id:'X51', nom:'Le Touriste d’Ailleurs', type:'depl', set:'IM', stage:1, rar:'legendaire',
 ...
 *
 * Les anciennes valeurs distinguaient star et crown ; leurs deux probabilités
 * sont additionnées ici, sinon la seconde entrée serait morte — `pickRarity`
 * s'arrête à la première qui correspond, et `legendaire` correspond déjà.
 */
const RATES = {
  4: [['rare',.80],['epique',.15],['legendaire',.05]],
  5: [['rare',.55],['epique',.30],['legendaire',.15]],
};
